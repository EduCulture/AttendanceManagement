<div class="page-header">
    <div class="container-fluid">
        <h1>Allopathy Words</h1>
        <ul class="breadcrumb">
            <li>
                <?php echo $this->Html->link('Home',array('controller' => 'dashboard')); ?>
            </li>
            <li>
                <?php echo $this->Html->link('Allopathy',array('controller' => 'allopathy')); ?>
            </li>
        </ul>
        <div class="pull-right">
           <?php echo $this->Html->link('<i class="fa fa-plus"></i>',array('controller' => 'allopathy','action' => 'add'),array('escape' => false,'data-original-title' => 'Add New','data-toggle' => 'tooltip','class' => 'btn btn-primary')); ?>
           <button onclick="confirm('Delete/Uninstall cannot be undone! Are you sure you want to do this?') ? $('#allopathy-list').submit() : false;" class="btn btn-danger" title="" data-toggle="tooltip" type="button" data-original-title="Delete"><i class="fa fa-trash-o"></i></button>
...
<div class="container-fluid">
    <div class="panel panel-default">
          <div class="panel-heading">
              <h3 class="panel-title"><i class="fa fa-list"></i> Allopathy Words List</h3>
          ...
          <div class="panel-body">
                  ...
                  <div class="col-sm-12">
                      <div class="panel panel-default">
                         <div class="panel-heading">
                            ...
                            <?php if($is_filter){ ?>
                                <?php echo $this->Html->link('<i class="fa fa-undo"></i>',array('controller' => 'allopathy','action' => 'index'),array('escape' => false,'data-original-title' => 'Reset Filter','data-toggle' => 'tooltip','class' => 'pull-right','style' => 'margin-right: 15px;')); ?>
                            <?php } ?>
                         </div>
                         <div class="panel-body collapse <?php echo ($is_filter) ? 'in' : ''; ?>" id="filter-panel">
                            <div class="well">
                                <form enctype="multipart/form-data" method="get" action="<?php echo $this->webroot; ?>allopathy/index">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="input-name" class="control-label">Word</label>
                                                <input type="text" class="form-control" id="input-name" placeholder="Word" value="<?php //echo $searchString; ?>" name="filter_word">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
              ...
              <form id="allopathy-list" enctype="multipart/form-data" method="post" action="<?php echo $this->webroot.'allopathy/delete'; ?>">
                                ...
                                <?php if($word_details) { ?>
                                    <?php foreach($word_details as $word) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                               <?php echo $this->Html->link('<i class="fa fa-pencil"></i>',array('controller' => 'allopathy','action' => 'edit','?' => array('word_id' => $word['Word']['id'])),array('escape' => false ,'class' => 'btn btn-primary','data-original-title' => 'Edit','data-toggle' => 'tooltip')); ?>
                                               <?php /*
                                                <a class="btn btn-primary" title="" data-toggle="tooltip" href="add_allopathy.php?word_id=<?php echo $term['id']; ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                               */ ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
