 ...
 */
    ...
    Configure::write('Routing.prefixes', array('services'));
 ...
 */
	Configure::write('Security.salt', 'Hbddfd#222$333hitKREEFGG@13%^');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '252536895632147475558');
